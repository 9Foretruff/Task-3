from translation_package.package.google_translator import TransLate, CodeLang
from translation_package.package.deep_translator import LangDetect
...
if __name__ == "__main__":
    try:
        text_file = r"C:\Users\mi200\Desktop\Task-3.txt"  # Specify the name of your text file
        config_file = r"C:\Users\mi200\PycharmProjects\RokitkoFirstTask\translation_package\config.txt"  # Specify the name of your config file
